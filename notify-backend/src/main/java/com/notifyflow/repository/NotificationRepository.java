...
public interface NotificationRepository extends JpaRepository<NotificationEntity, Long> {
    ...
    /**
     * Counts notifications by status globally (or per user).
     */
    long countByStatus(NotificationStatus status);

    /**
     * Counts notifications by channel globally (or per user).
     */
    long countByChannel(NotificationChannel channel);

    /**
     * Counts notifications created after a given time.
     */
    long countByCreatedAtAfter(LocalDateTime after);

    /**
     * Finds all notifications created after a given time.
     */
    List<NotificationEntity> findByCreatedAtAfter(LocalDateTime after);

    /**
     * Counts notifications by status created after a given time.
     */
