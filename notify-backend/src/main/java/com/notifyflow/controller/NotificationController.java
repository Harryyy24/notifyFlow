...
public class NotificationController {
    ...
    @Operation(
            ...
            description = "Returns aggregated stats (total, byStatus, byChannel). " +
                    "Optional ?days=N filters to last N days."
    )
    @GetMapping("/stats")
    public ResponseEntity<NotificationStatsDTO> getStats(
            @RequestParam(required = false) Integer days) {
        return ResponseEntity.ok(notificationService.getStats(days));
    }
